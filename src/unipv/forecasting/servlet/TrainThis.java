...
public class TrainThis extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1109276153602740603L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (numberInDaysString == null || ("").equals(numberInDaysString)) {
			...
			if ((numberInDays < 0) || (numberInDays > 15)) {
				...
				JSONObject json = system.trainThis(numberInDays);
				if (json != null)
